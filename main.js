!function() {
    ...
    var e = {
        ...
        d: function(t, a) {
            for (var o in a)
                e.o(a, o) && !e.o(t, o) && Object.defineProperty(t, o, {
                    enumerable: !0,
                    get: a[o]
                })
        },
    ...
    let r = ""
      , l = "";
    n() ? (r = "starterTemplatePreviewDispatch",
    l = "starter-templates-iframe-preview-data") : (r = "showcaseCTAPreviewDispatch",
    l = "showcase-cta-preview-data");
    const i = ()=>{
        let e = "";
    ...
    const d = (e,t)=>{
      ...
      , m = e=>{
        ...
        case "siteLogo":
            ...
            if (a = e.value.data.dataUri || a,
            0 === t.length && "" !== a) {
                const t = document.createElement("span");
                t.classList.add("site-logo-img");
                const o = document.createElement("img");
                o.classList.add("custom-logo"),
                ...
                for (const [o,n] of Object.entries(t)) {
                    ...
                    "" !== t && a !== c ? (n.style.width = t + "px",
                    n.style.maxWidth = t + "px") : (n.style.width = "",
                    n.style.maxWidth = "")
                }
                (()=>{
        ...
        case "colorPalette":
            ...
            const r = Object.entries(o).map(((e,t)=>[`--e-global-color-${s[t].replace(/-/g, "")}: ${e[1]};`, `${n}${t}: ${e[1]};`])).map((e=>e.join(""))).join("");
            let l = document.getElementById("starter-templates-preview-palette-css");
            l || (l = document.createElement("style"),
            l.id = "starter-templates-preview-palette-css",
            l.setAttribute("rel", "stylesheet"),
            document.head.appendChild(l)),
            l.innerHTML = `.starter-templates-preview-palette{ ${r} }`;
            break;
        case "siteTypography":
            ...
            (e=>{
                ...
                document.head.appendChild(t));
                let a = "";
                a += "body, button, input, select, textarea, .ast-button, .ast-custom-button {",
                a += "\tfont-family: " + e["body-font-family"] + ";",
                a += "\tfont-weight: " + e["body-font-weight"] + ";",
                a += "\tfont-size: " + e["font-size-body"].desktop + e["font-size-body"]["desktop-unit"] + ";",
                a += "\tline-height: " + e["body-line-height"] + ";",
                a += "}",
                a += "h1, .entry-content h1, h2, .entry-content h2, h3, .entry-content h3, h4, .entry-content h4, h5, .entry-content h5, h6, .entry-content h6, .site-title, .site-title a {",
                ...
                ["h1", "h2", "h3", "h4", "h5", "h6"].forEach((t=>{
                    ...
                    a += `${t}, .entry-content ${t} {`,
                    a += "\tfont-family: " + o + ";",
                    "" !== e["line-height-" + t] && (a += "\tline-height: " + e["line-height-" + t] + ";"),
                    a += "\tfont-weight: " + n + ";",
                    a += "}"
                }
                )),
    ...
    window.addEventListener("message", (function(e) {
        if ("object" == typeof e.data && r === e.data.call) {
            ...
            n())
                ...
                a.url = showcaseCTA.path;
                const e = (new Date).getTime();
                a.timestamp = e
            }
            "cleanStorage" === t.value.param ? (delete a.data.cleanStorage,
            a.data.siteLogo = t.value.data,
            a.data.colorPalette = {},
            a.data.siteTypography = {},
            Object.keys(a.data).map((e=>m({
                value: {
                    param: e,
                    data: a.data[e]
                }
    ...
    a()((()=>{
        if (n()) {
            ...
            e.innerHTML = ".site-logo-img img { transition: unset; }"
        }
        if (!n()) {
            const e = (0,
            o.getQueryArgs)(window.location.search).customize || "";
            if ("" === e)
                return;
        ...
        if (e) {
            ...
            if (!n() && (e.url !== showcaseCTA.path || t > a)) {
                ...
                return t && t.remove(),
                void localStorage.removeItem(l)
            }
